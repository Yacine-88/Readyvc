...
const COMPARABLES_DATA: Deal[] = [
  ...
  // AFRICA — 2026
  { name: "Qareeb", country: "Algeria", flag: "🇩🇿", geo: "africa", sector: "agritech", stage: "seed", raised: 2, valuation: null, multiple: null, year: 2026, note: "AgriTech, Algeria" },
  { name: "Volz", country: "Algeria", flag: "🇩🇿", geo: "africa", sector: "travel", stage: "seriesA", raised: 5, valuation: null, multiple: null, year: 2026, note: "Travel Tech, Algeria" },
];
        ...
        <div className="max-w-6xl mx-auto px-6 py-6">
          <div className="flex flex-wrap gap-6">
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="flex gap-2">
                {(["all", "fintech", "saas", "agritech", "marketplace", "travel"] as const).map((sector) => (
                  <button
                    key={sector}
