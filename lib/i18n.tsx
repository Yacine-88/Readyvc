...
const translations = {
  en: {
    ...
    "cta.subtitle": "VCReady gives you the tools and insights to walk into investor meetings with confidence.",
    ...
    "about.para2": "In practice, this leads to a gap. Founders may have strong ideas, relevant markets, and real traction, but struggle to clearly articulate their performance through key indicators such as growth, unit economics, runway, or valuation logic.",
    ...
    "pitch.description": "Structure and validate your pitch against what investors actually look for.",
  ...
  fr: {
    ...
    "tool.valuation.desc": "Obtenez une estimation data-driven de la valorisation de votre entreprise.",
    "tool.metrics.title": "Suivi des indicateurs",
    "tool.metrics.desc": "Suivez et comparez vos indicateurs cles aux standards du marche.",
    "tool.pitch.title": "Constructeur de pitch",
    "tool.pitch.desc": "Structurez votre pitch avec des frameworks eprouves.",
    "tool.dataroom.kicker": "Data Room",
    "tool.dataroom.title": "Checklist Data Room",
    "tool.dataroom.desc": "Assurez-vous que votre data room est complete avec notre checklist exhaustive.",
    ...
    "cta.subtitle": "VCReady vous donne les outils et insights pour entrer en meeting investisseur avec confiance.",
    "cta.primary": "Commencer",
    "cta.secondary": "Essayer un outil d'abord",
    "cta.bookSession": "Reserver une session",
    "cta.bookSession.desc": "Planifiez un appel de 30 minutes avec notre equipe.",
    "footer.by": "par",
    "footer.tools": "Outils",
    ...
    "about.title": "A propos de VCReady",
    "about.para1": "VCReady est ne d'un constat simple observe dans de nombreux ecosystemes startup : beaucoup de fondateurs abordent la levee de fonds sans maitriser les metriques attendues par les investisseurs.",
    "about.para2": "Dans la pratique, cela cree un decalage. Les fondateurs peuvent avoir de bonnes idees, un marche pertinent et meme de la traction, mais peinent a structurer leur discours autour d'indicateurs cles.",
    "about.para3": "VCReady a ete concu pour combler cet ecart. La plateforme propose des outils structures pour aider les fondateurs a mieux comprendre leur activite.",
    "about.founder.title": "Fondateur",
    "about.founder.name": "Yacine Chikhar",
    "about.founder.bio": "Depuis plus de 10 ans, je concois et pilote des programmes d'accompagnement destines aux entrepreneurs, incubateurs, institutions et acteurs publics. Ayant accompagne plus de 100 entrepreneurs, j'ai developpe des programmes et des outils pratiques.",
    ...
    "metrics.description": "KPIs specifiques par secteur que les investisseurs demanderont.",
    ...
    "pitch.description": "Structurez et validez votre pitch contre ce que les investisseurs recherchent vraiment.",
    ...
    "dataroom.description": "Suivez votre progression et assurez-vous que rien ne manque lors de la due diligence.",
    ...
    "qa.description": "Les questions que les investisseurs poseront, et comment y repondre.",
  ...
  return (
    <div className="flex items-center gap-1 text-xs font-medium">
      ...
      <button
        ...
        className={`px-2 py-1 rounded transition-colors ${
          locale === "fr" ? "bg-ink text-white" : "text-muted hover:text-ink"
        }`}
      >
        FR
      </button>
