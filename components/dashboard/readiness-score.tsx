...
export function ReadinessScore() {
  ...
  const categories = [
    { label: t("nav.metrics"), score: score?.metrics_score || 0, status: (score?.metrics_score || 0) >= 70 ? "good" : "warning", href: "/metrics" },
    { label: t("nav.valuation"), score: score?.valuation_score || 0, status: (score?.valuation_score || 0) >= 70 ? "good" : "warning", href: "/valuation" },
    { label: t("nav.dataroom"), score: score?.dataroom_score || 0, status: (score?.dataroom_score || 0) >= 70 ? "good" : "warning", href: "/dataroom" },
    { label: t("nav.pitch"), score: score?.pitch_score || 0, status: (score?.pitch_score || 0) >= 70 ? "good" : "warning", href: "/pitch" },
  ];
        ...
        <div className="grid md:grid-cols-[140px_1fr] gap-6 items-center mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-ink-secondary leading-relaxed">
              {overallScore >= 80
                ? "You're well-prepared for investor meetings. Focus on the final details."
                : overallScore >= 60
                ? "You have a solid foundation. Focus on completing your data room and refining your pitch."
                : "Keep building out your profile. Complete each tool to improve your readiness."}
            </p>
          </div>
        </div>
